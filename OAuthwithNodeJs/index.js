...
const productDBHelper = require('./databaseHelpers/productsDBHelper')(mySqlConnection)
...
const restrictedAreaRoutesMethods = require('./restrictedArea/restrictedAreaRoutesMethods.js')(productDBHelper)
